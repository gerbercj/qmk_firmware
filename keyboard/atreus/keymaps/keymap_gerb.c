...
[_L1] = { /* LAYER 1 */
  ...
  {TG(_L2), KC_APP,  KC_LGUI, KC_LSFT, KC_DEL,  KC_RCTL, KC_SPC,  KC_TRNS, KC_DOT,  KC_0,    KC_EQL }
},
[_L2] = { /* LAYER 2 */
  ...
  {KC_TRNS, KC_TRNS, KC_LGUI, KC_LSFT, KC_BSPC, KC_RCTL, KC_SPC,  KC_TRNS, KC_TRNS, KC_TRNS, KC_FN0 }
}
};
